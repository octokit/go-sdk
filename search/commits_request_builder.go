...
import (
    ...
    i67dbd6654edaeda4faa39906aa90474f4723812a71c047b63eed3a2c762fb60c "github.com/octokit/go-sdk/search/commits"
)
...
type CommitsRequestBuilderGetQueryParameters struct {
    ...
    // Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`.
    OrderAsGetOrderQueryParameterType *i67dbd6654edaeda4faa39906aa90474f4723812a71c047b63eed3a2c762fb60c.GetOrderQueryParameterType `uriparametername:"order"`
    ...
    // Sorts the results of your query by `author-date` or `committer-date`. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
    SortAsGetSortQueryParameterType *i67dbd6654edaeda4faa39906aa90474f4723812a71c047b63eed3a2c762fb60c.GetSortQueryParameterType `uriparametername:"sort"`
}
