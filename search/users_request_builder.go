...
import (
    ...
    ife1b6c575102692afc070a630b2c8967c102b4291f57df044e48374d28c777de "github.com/octokit/go-sdk/search/users"
)
...
type UsersRequestBuilderGetQueryParameters struct {
    ...
    // Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`.
    OrderAsGetOrderQueryParameterType *ife1b6c575102692afc070a630b2c8967c102b4291f57df044e48374d28c777de.GetOrderQueryParameterType `uriparametername:"order"`
    ...
    // Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
    SortAsGetSortQueryParameterType *ife1b6c575102692afc070a630b2c8967c102b4291f57df044e48374d28c777de.GetSortQueryParameterType `uriparametername:"sort"`
}
...
func (m *UsersRequestBuilder) Get(ctx context.Context, requestConfiguration *UsersRequestBuilderGetRequestConfiguration)(UsersResponseable, error) {
    ...
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        ...
        "503": i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateUsers503ErrorFromDiscriminatorValue,
    }
