...
import (
    ...
    i713b97a6b81f32d6e0305cddad3dcea2d630e9d1e22f534fe93861671978fbbb "github.com/octokit/go-sdk/search/labels"
)
...
type LabelsRequestBuilderGetQueryParameters struct {
    ...
    // Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`.
    OrderAsGetOrderQueryParameterType *i713b97a6b81f32d6e0305cddad3dcea2d630e9d1e22f534fe93861671978fbbb.GetOrderQueryParameterType `uriparametername:"order"`
    ...
    // Sorts the results of your query by when the label was `created` or `updated`. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
    SortAsGetSortQueryParameterType *i713b97a6b81f32d6e0305cddad3dcea2d630e9d1e22f534fe93861671978fbbb.GetSortQueryParameterType `uriparametername:"sort"`
}
