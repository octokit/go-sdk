...
// ByPackage_version_id gets an item from the go-sdk.users.item.packages.item.item.versions.item collection
...
// ByPackage_version_idInteger gets an item from the go-sdk.users.item.packages.item.item.versions.item collection
