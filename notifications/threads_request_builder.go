...
// ByThread_id gets an item from the go-sdk.notifications.threads.item collection
...
// ByThread_idInteger gets an item from the go-sdk.notifications.threads.item collection
