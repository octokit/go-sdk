...
import (
    ...
    i9b5bca9b165f4124b112ced2c969e5bc09e6e9efcd5df97c9104fa00a6d25a3b "github.com/octokit/go-sdk/orgs/item/rulesets/rulesuites"
)
...
type ItemRulesetsRuleSuitesRequestBuilderGetQueryParameters struct {
    ...
    // The rule results to filter on. When specified, only suites with this result will be returned.
    Rule_suite_resultAsGetRule_suite_resultQueryParameterType *i9b5bca9b165f4124b112ced2c969e5bc09e6e9efcd5df97c9104fa00a6d25a3b.GetRule_suite_resultQueryParameterType `uriparametername:"rule_suite_result"`
    ...
    // The time period to filter by.For example, `day` will filter for rule suites that occurred in the past 24 hours, and `week` will filter for insights that occurred in the past 7 days (168 hours).
    Time_periodAsGetTime_periodQueryParameterType *i9b5bca9b165f4124b112ced2c969e5bc09e6e9efcd5df97c9104fa00a6d25a3b.GetTime_periodQueryParameterType `uriparametername:"time_period"`
}
...
// ByRule_suite_id gets an item from the go-sdk.orgs.item.rulesets.ruleSuites.item collection
...
// ByRule_suite_idInteger gets an item from the go-sdk.orgs.item.rulesets.ruleSuites.item collection
...
func (m *ItemRulesetsRuleSuitesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRulesetsRuleSuitesRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RuleSuitesable, error) {
