...
import (
    ...
    iab4f489090518e9013c4d6c661025aa1541f90fede1206e77961deeb15855a23 "github.com/octokit/go-sdk/orgs/item/dependabot/alerts"
)
...
type ItemDependabotAlertsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *iab4f489090518e9013c4d6c661025aa1541f90fede1206e77961deeb15855a23.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The scope of the vulnerable dependency. If specified, only alerts with this scope will be returned.
    ScopeAsGetScopeQueryParameterType *iab4f489090518e9013c4d6c661025aa1541f90fede1206e77961deeb15855a23.GetScopeQueryParameterType `uriparametername:"scope"`
    ...
    // The property by which to sort the results.`created` means when the alert was created.`updated` means when the alert's state last changed.
    SortAsGetSortQueryParameterType *iab4f489090518e9013c4d6c661025aa1541f90fede1206e77961deeb15855a23.GetSortQueryParameterType `uriparametername:"sort"`
...
func (m *ItemDependabotAlertsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDependabotAlertsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.DependabotAlertWithRepositoryable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateDependabotAlertWithRepositoryFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.DependabotAlertWithRepositoryable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.DependabotAlertWithRepositoryable)
        }
    }
    return val, nil
}
