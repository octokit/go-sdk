...
type ItemActionsVariablesGetResponse struct {
    ...
    variables []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable
}
...
func (m *ItemActionsVariablesGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["variables"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateOrganizationActionsVariableFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable)
                }
            }
            m.SetVariables(res)
        }
...
func (m *ItemActionsVariablesGetResponse) GetVariables()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable) {
    return m.variables
}
...
func (m *ItemActionsVariablesGetResponse) SetVariables(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable)() {
    m.variables = value
}
...
type ItemActionsVariablesGetResponseable interface {
    ...
    GetTotalCount()(*int32)
    GetVariables()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable)
    SetTotalCount(value *int32)()
    SetVariables(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationActionsVariableable)()
}
