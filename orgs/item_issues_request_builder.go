...
import (
    ...
    id30176c30787e59667782f1b80ca1f01c247f943c8b61f6694d10e760277388f "github.com/octokit/go-sdk/orgs/item/issues"
)
...
type ItemIssuesRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *id30176c30787e59667782f1b80ca1f01c247f943c8b61f6694d10e760277388f.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // Indicates which sorts of issues to return. `assigned` means issues assigned to you. `created` means issues created by you. `mentioned` means issues mentioning you. `subscribed` means issues you're subscribed to updates for. `all` or `repos` means all issues you can see, regardless of participation or creation.
    FilterAsGetFilterQueryParameterType *id30176c30787e59667782f1b80ca1f01c247f943c8b61f6694d10e760277388f.GetFilterQueryParameterType `uriparametername:"filter"`
    ...
    // What to sort results by.
    SortAsGetSortQueryParameterType *id30176c30787e59667782f1b80ca1f01c247f943c8b61f6694d10e760277388f.GetSortQueryParameterType `uriparametername:"sort"`
    // Indicates the state of the issues to return.
    // Deprecated: This property is deprecated, use stateAsGetStateQueryParameterType instead
    State *string `uriparametername:"state"`
    // Indicates the state of the issues to return.
    StateAsGetStateQueryParameterType *id30176c30787e59667782f1b80ca1f01c247f943c8b61f6694d10e760277388f.GetStateQueryParameterType `uriparametername:"state"`
}
...
func (m *ItemIssuesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemIssuesRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Issueable, error) {
