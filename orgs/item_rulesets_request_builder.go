...
// ByRuleset_id gets an item from the go-sdk.orgs.item.rulesets.item collection
...
// ByRuleset_idInteger gets an item from the go-sdk.orgs.item.rulesets.item collection
...
func (m *ItemRulesetsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemRulesetsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RepositoryRulesetable, error) {
...
func (m *ItemRulesetsRequestBuilder) Post(ctx context.Context, body ItemRulesetsPostRequestBodyable, requestConfiguration *ItemRulesetsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RepositoryRulesetable, error) {
