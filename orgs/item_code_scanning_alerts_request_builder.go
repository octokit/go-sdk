...
import (
    ...
    ie59ae3bdecfea1aab3ab611fcd869cadf823598dee45de1e8ab62131d6a8107e "github.com/octokit/go-sdk/orgs/item/codescanning/alerts"
)
...
type ItemCodeScanningAlertsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *ie59ae3bdecfea1aab3ab611fcd869cadf823598dee45de1e8ab62131d6a8107e.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property by which to sort the results.
    SortAsGetSortQueryParameterType *ie59ae3bdecfea1aab3ab611fcd869cadf823598dee45de1e8ab62131d6a8107e.GetSortQueryParameterType `uriparametername:"sort"`
...
func (m *ItemCodeScanningAlertsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemCodeScanningAlertsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CodeScanningOrganizationAlertItemsable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateCodeScanningOrganizationAlertItemsFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CodeScanningOrganizationAlertItemsable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CodeScanningOrganizationAlertItemsable)
        }
    }
    return val, nil
}
