...
// ByOwner gets an item from the go-sdk.orgs.item.teams.item.repos.item collection
...
func (m *ItemTeamsItemReposRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamsItemReposRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.MinimalRepositoryable, error) {
