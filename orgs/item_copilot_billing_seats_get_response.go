...
type ItemCopilotBillingSeatsGetResponse struct {
    ...
    // The seats property
    seats []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable
...
func (m *ItemCopilotBillingSeatsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["seats"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateCopilotSeatDetailsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable)
                }
            }
            m.SetSeats(res)
        }
...
func (m *ItemCopilotBillingSeatsGetResponse) GetSeats()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable) {
    return m.seats
}
...
func (m *ItemCopilotBillingSeatsGetResponse) SetSeats(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable)() {
    m.seats = value
}
...
type ItemCopilotBillingSeatsGetResponseable interface {
    ...
    GetSeats()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable)
    GetTotalSeats()(*int32)
    SetSeats(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CopilotSeatDetailsable)()
