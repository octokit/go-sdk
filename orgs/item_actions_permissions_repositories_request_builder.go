...
// ByRepository_id gets an item from the go-sdk.orgs.item.actions.permissions.repositories.item collection
...
// ByRepository_idInteger gets an item from the go-sdk.orgs.item.actions.permissions.repositories.item collection
