...
import (
    ...
    i163f1cc2a9231942725cc810bcf484cb2c44789d081d7ddad099f5f09be3f83e "github.com/octokit/go-sdk/orgs/item/personalaccesstokenrequests"
)
...
type ItemPersonalAccessTokenRequestsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *i163f1cc2a9231942725cc810bcf484cb2c44789d081d7ddad099f5f09be3f83e.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property by which to sort the results.
    SortAsGetSortQueryParameterType *i163f1cc2a9231942725cc810bcf484cb2c44789d081d7ddad099f5f09be3f83e.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByPat_request_id gets an item from the go-sdk.orgs.item.personalAccessTokenRequests.item collection
...
// ByPat_request_idInteger gets an item from the go-sdk.orgs.item.personalAccessTokenRequests.item collection
...
func (m *ItemPersonalAccessTokenRequestsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPersonalAccessTokenRequestsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationProgrammaticAccessGrantRequestable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateOrganizationProgrammaticAccessGrantRequestFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationProgrammaticAccessGrantRequestable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationProgrammaticAccessGrantRequestable)
        }
    }
    return val, nil
}
