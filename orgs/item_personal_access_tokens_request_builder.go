...
import (
    ...
    i0704f0b33c4ce6e1af75b74c1fcba1ed4395a5187b1382647fc21bea63728c24 "github.com/octokit/go-sdk/orgs/item/personalaccesstokens"
)
...
type ItemPersonalAccessTokensRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *i0704f0b33c4ce6e1af75b74c1fcba1ed4395a5187b1382647fc21bea63728c24.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property by which to sort the results.
    SortAsGetSortQueryParameterType *i0704f0b33c4ce6e1af75b74c1fcba1ed4395a5187b1382647fc21bea63728c24.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByPat_id gets an item from the go-sdk.orgs.item.personalAccessTokens.item collection
...
// ByPat_idInteger gets an item from the go-sdk.orgs.item.personalAccessTokens.item collection
...
func (m *ItemPersonalAccessTokensRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPersonalAccessTokensRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationProgrammaticAccessGrantable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateOrganizationProgrammaticAccessGrantFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationProgrammaticAccessGrantable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationProgrammaticAccessGrantable)
        }
    }
    return val, nil
}
