...
import (
    ...
    i6a1be8e05acbe611c04cbb356928d0a56a934803e618adfd7b7bf3692b0a9dcc "github.com/octokit/go-sdk/orgs/item/teams/item/discussions/item/comments/item/reactions"
)
...
type ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion comment.
    ContentAsGetContentQueryParameterType *i6a1be8e05acbe611c04cbb356928d0a56a934803e618adfd7b7bf3692b0a9dcc.GetContentQueryParameterType `uriparametername:"content"`
...
// ByReaction_id gets an item from the go-sdk.orgs.item.teams.item.discussions.item.comments.item.reactions.item collection
...
// ByReaction_idInteger gets an item from the go-sdk.orgs.item.teams.item.discussions.item.comments.item.reactions.item collection
...
func (m *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Reactionable, error) {
...
func (m *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilder) Post(ctx context.Context, body ItemTeamsItemDiscussionsItemCommentsItemReactionsPostRequestBodyable, requestConfiguration *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Reactionable, error) {
