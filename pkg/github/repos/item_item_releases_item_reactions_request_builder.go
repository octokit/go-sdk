...
type ItemItemReleasesItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a release.
    ContentAsGetContentQueryParameterType *id55cffcf6bbb94221b5dee244a08d4356fef6defe3cbba2cf764187f9d0ca7d2.GetContentQueryParameterType `uriparametername:"content"`
...
// ByReaction_idInteger gets an item from the github.com/octokit/go-sdk/pkg/github/.repos.item.item.releases.item.reactions.item collection
...
func (m *ItemItemReleasesItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemReleasesItemReactionsRequestBuilderGetRequestConfiguration)([]i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.Reactionable, error) {
