...
type ItemItemForksRequestBuilderGetQueryParameters struct {
    ...
    // The sort order. `stargazers` will sort by star count.
    SortAsGetSortQueryParameterType *ia8522d4fb15ab1318931fab69bc994cc5db2188067860f52c78d065e2adc8db4.GetSortQueryParameterType `uriparametername:"sort"`
}
...
func (m *ItemItemForksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemForksRequestBuilderGetRequestConfiguration)([]i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.MinimalRepositoryable, error) {
...
func (m *ItemItemForksRequestBuilder) Post(ctx context.Context, body ItemItemForksPostRequestBodyable, requestConfiguration *ItemItemForksRequestBuilderPostRequestConfiguration)(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.FullRepositoryable, error) {
