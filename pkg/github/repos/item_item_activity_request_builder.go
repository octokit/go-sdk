...
type ItemItemActivityRequestBuilderGetQueryParameters struct {
    ...
    // The activity type to filter by.For example, you can choose to filter by "force_push", to see all force pushes to the repository.
    Activity_typeAsGetActivity_typeQueryParameterType *ia4d3c00087c8cd3d0487630fd16ea548b5ca8c46c90d4b6d272efa6624a02bb6.GetActivity_typeQueryParameterType `uriparametername:"activity_type"`
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *ia4d3c00087c8cd3d0487630fd16ea548b5ca8c46c90d4b6d272efa6624a02bb6.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The time period to filter by.For example, `day` will filter for activity that occurred in the past 24 hours, and `week` will filter for activity that occurred in the past 7 days (168 hours).
    Time_periodAsGetTime_periodQueryParameterType *ia4d3c00087c8cd3d0487630fd16ea548b5ca8c46c90d4b6d272efa6624a02bb6.GetTime_periodQueryParameterType `uriparametername:"time_period"`
}
...
func (m *ItemItemActivityRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemActivityRequestBuilderGetRequestConfiguration)([]i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.Activityable, error) {
