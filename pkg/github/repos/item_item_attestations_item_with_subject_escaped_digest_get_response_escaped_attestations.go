...
func (m *ItemItemAttestationsItemWithSubject_digestGetResponse_attestations) GetBundleUrl()(*string) {
    return m.bundle_url
}
...
func (m *ItemItemAttestationsItemWithSubject_digestGetResponse_attestations) SetBundleUrl(value *string)() {
    m.bundle_url = value
}
