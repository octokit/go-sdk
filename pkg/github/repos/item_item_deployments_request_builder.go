...
// ByDeployment_idInteger gets an item from the github.com/octokit/go-sdk/pkg/github/.repos.item.item.deployments.item collection
...
func (m *ItemItemDeploymentsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemDeploymentsRequestBuilderGetRequestConfiguration)([]i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.Deploymentable, error) {
...
func (m *ItemItemDeploymentsRequestBuilder) Post(ctx context.Context, body ItemItemDeploymentsPostRequestBodyable, requestConfiguration *ItemItemDeploymentsRequestBuilderPostRequestConfiguration)(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.Deploymentable, error) {
