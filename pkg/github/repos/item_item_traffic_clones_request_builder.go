...
type ItemItemTrafficClonesRequestBuilderGetQueryParameters struct {
    ...
    // The time frame to display results for.
    PerAsGetPerQueryParameterType *i1d0f28263915d5f59d46016ea25888da94f489536a9769cb5698c30da42ce737.GetPerQueryParameterType `uriparametername:"per"`
}
...
func (m *ItemItemTrafficClonesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemTrafficClonesRequestBuilderGetRequestConfiguration)(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.CloneTrafficable, error) {
