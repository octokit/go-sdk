...
// NewCustomPropertyValue_CustomPropertyValue_value instantiates a new customPropertyValue_value and sets the default values.
...
// CustomPropertyValue_CustomPropertyValue_valueable 
