...
// GetName gets the name property value. Name of the model used for Copilot pull request summaries. If the default model is used will appear as 'default'.
// returns a *string when successful
...
// SetName sets the name property value. Name of the model used for Copilot pull request summaries. If the default model is used will appear as 'default'.
