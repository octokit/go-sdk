...
func (m *CodeScanningAlertItems) GetDismissalApprovedBy()(NullableSimpleUserable) {
...
func (m *CodeScanningAlertItems) SetDismissalApprovedBy(value NullableSimpleUserable)() {
