...
type ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody struct {
    ...
    secret_scanning_delegated_bypass_options ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable
}
...
func (m *ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["secret_scanning_delegated_bypass_options"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSecretScanningDelegatedBypassOptions(val.(ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable))
        }
        return nil
    }
    return res
...
// returns a ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable when successful
func (m *ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody) GetSecretScanningDelegatedBypassOptions()(ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable) {
...
func (m *ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody) SetSecretScanningDelegatedBypassOptions(value ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable)() {
...
type ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBodyable interface {
    ...
    GetName()(*string)
    GetSecretScanningDelegatedBypassOptions()(ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable)
    ...
    SetSecretScanningDelegatedBypassOptions(value ItemCodeSecurityConfigurationsItemWithConfiguration_PatchRequestBody_secret_scanning_delegated_bypass_optionsable)()
}
