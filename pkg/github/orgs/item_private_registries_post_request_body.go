...
type ItemPrivateRegistriesPostRequestBody struct {
...
// NewItemPrivateRegistriesPostRequestBody instantiates a new ItemPrivateRegistriesPostRequestBody and sets the default values.
func NewItemPrivateRegistriesPostRequestBody()(*ItemPrivateRegistriesPostRequestBody) {
    m := &ItemPrivateRegistriesPostRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemPrivateRegistriesPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemPrivateRegistriesPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemPrivateRegistriesPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemPrivateRegistriesPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetEncryptedValue gets the encrypted_value property value. The value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get private registries public key for an organization](https://docs.github.com/rest/private-registries/organization-configurations#get-private-registries-public-key-for-an-organization) endpoint.
// returns a *string when successful
func (m *ItemPrivateRegistriesPostRequestBody) GetEncryptedValue()(*string) {
    return m.encrypted_value
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ItemPrivateRegistriesPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *ItemPrivateRegistriesPostRequestBody) GetKeyId()(*string) {
    return m.key_id
}
...
func (m *ItemPrivateRegistriesPostRequestBody) GetSelectedRepositoryIds()([]int32) {
...
// returns a *string when successful
func (m *ItemPrivateRegistriesPostRequestBody) GetUsername()(*string) {
    return m.username
}
// Serialize serializes information the current object
func (m *ItemPrivateRegistriesPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemPrivateRegistriesPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetEncryptedValue sets the encrypted_value property value. The value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get private registries public key for an organization](https://docs.github.com/rest/private-registries/organization-configurations#get-private-registries-public-key-for-an-organization) endpoint.
func (m *ItemPrivateRegistriesPostRequestBody) SetEncryptedValue(value *string)() {
    m.encrypted_value = value
}
// SetKeyId sets the key_id property value. The ID of the key you used to encrypt the secret.
func (m *ItemPrivateRegistriesPostRequestBody) SetKeyId(value *string)() {
    m.key_id = value
}
// SetSelectedRepositoryIds sets the selected_repository_ids property value. An array of repository IDs that can access the organization private registry. You can only provide a list of repository IDs when `visibility` is set to `selected`. You can manage the list of selected repositories using the [Update a private registry for an organization](https://docs.github.com/rest/private-registries/organization-configurations#update-a-private-registry-for-an-organization) endpoint. This field should be omitted if `visibility` is set to `all` or `private`.
func (m *ItemPrivateRegistriesPostRequestBody) SetSelectedRepositoryIds(value []int32)() {
...
func (m *ItemPrivateRegistriesPostRequestBody) SetUsername(value *string)() {
    m.username = value
}
type ItemPrivateRegistriesPostRequestBodyable interface {
