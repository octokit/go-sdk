...
// ByAuthor_id gets an item from the octokit.repos.item.item.import.authors.item collection
...
// ByAuthor_idInteger gets an item from the octokit.repos.item.item.import.authors.item collection
// Deprecated: 
...
func (m *ItemItemImportAuthorsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemImportAuthorsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.PorterAuthorable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreatePorterAuthorFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.PorterAuthorable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.PorterAuthorable)
        }
    }
    return val, nil
}
