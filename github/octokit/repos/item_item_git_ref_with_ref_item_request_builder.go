...
func NewItemItemGitRefWithRefItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemGitRefWithRefItemRequestBuilder) {
    m := &ItemItemGitRefWithRefItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/git/ref/{ref}", pathParameters),
    }
    return m
}
...
func (m *ItemItemGitRefWithRefItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemGitRefWithRefItemRequestBuilderGetRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.GitRefable, error) {
