...
// ByName gets an item from the octokit.repos.item.item.labels.item collection
...
func (m *ItemItemLabelsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemLabelsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Labelable, error) {
...
func (m *ItemItemLabelsRequestBuilder) Post(ctx context.Context, body ItemItemLabelsPostRequestBodyable, requestConfiguration *ItemItemLabelsRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Labelable, error) {
