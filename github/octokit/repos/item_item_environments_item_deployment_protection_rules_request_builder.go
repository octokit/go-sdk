...
// ByProtection_rule_id gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.environments.item.deployment_protection_rules.item collection
...
// ByProtection_rule_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.environments.item.deployment_protection_rules.item collection
...
func (m *ItemItemEnvironmentsItemDeployment_protection_rulesRequestBuilder) Post(ctx context.Context, body ItemItemEnvironmentsItemDeployment_protection_rulesPostRequestBodyable, requestConfiguration *ItemItemEnvironmentsItemDeployment_protection_rulesRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.DeploymentProtectionRuleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateDeploymentProtectionRuleFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.DeploymentProtectionRuleable), nil
}
