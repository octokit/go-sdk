...
type ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponse struct {
    ...
    available_custom_deployment_protection_rule_integrations []i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable
...
func (m *ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponse) GetAvailableCustomDeploymentProtectionRuleIntegrations()([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable) {
...
func (m *ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["available_custom_deployment_protection_rule_integrations"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateCustomDeploymentRuleAppFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable)
                }
            }
...
func (m *ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponse) SetAvailableCustomDeploymentProtectionRuleIntegrations(value []i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable)() {
...
type ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponseable interface {
    ...
    GetAvailableCustomDeploymentProtectionRuleIntegrations()([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable)
    GetTotalCount()(*int32)
    SetAvailableCustomDeploymentProtectionRuleIntegrations(value []i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CustomDeploymentRuleAppable)()
