...
// ItemItemHooksRequestBuilder builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\hooks
...
// ByHook_id gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.hooks.item collection
...
// ByHook_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.hooks.item collection
...
func NewItemItemHooksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemHooksRequestBuilder) {
    m := &ItemItemHooksRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/hooks{?per_page*,page*}", pathParameters),
    }
    return m
}
...
func (m *ItemItemHooksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemHooksRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Hookable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateHookFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Hookable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Hookable)
        }
    }
    return val, nil
}
...
func (m *ItemItemHooksRequestBuilder) Post(ctx context.Context, body ItemItemHooksPostRequestBodyable, requestConfiguration *ItemItemHooksRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Hookable, error) {
