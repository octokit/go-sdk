...
// ByCommit_sha gets an item from the octokit.repos.item.item.commits.item collection
...
func NewItemItemCommitsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemCommitsRequestBuilder) {
    m := &ItemItemCommitsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/repos/{owner}/{repo}/commits{?sha*,path*,author*,committer*,since*,until*,per_page*,page*}", pathParameters),
    }
    return m
}
...
func (m *ItemItemCommitsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemCommitsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Commitable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateCommitFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
