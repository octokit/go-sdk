...
// ByKey_id gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.keys.item collection
...
// ByKey_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.keys.item collection
...
func (m *ItemItemKeysRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemKeysRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.DeployKeyable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateDeployKeyFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    val := make([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.DeployKeyable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.DeployKeyable)
        }
    }
    return val, nil
}
...
func (m *ItemItemKeysRequestBuilder) Post(ctx context.Context, body ItemItemKeysPostRequestBodyable, requestConfiguration *ItemItemKeysRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.DeployKeyable, error) {
