...
import (
    ...
    ia72f7c538d312d2e25ada0a6a49bc16b669f6398b8aae73c146da8b1a7585555 "github.com/octokit/go-sdk/github/octokit/repos/item/item/pulls/comments/item/reactions"
)

// ItemItemPullsCommentsItemReactionsRequestBuilder builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\pulls\comments\{comment_id}\reactions
...
type ItemItemPullsCommentsItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a pull request review comment.
    ContentAsGetContentQueryParameterType *ia72f7c538d312d2e25ada0a6a49bc16b669f6398b8aae73c146da8b1a7585555.GetContentQueryParameterType `uriparametername:"content"`
...
// ByReaction_id gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.pulls.comments.item.reactions.item collection
...
// ByReaction_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.pulls.comments.item.reactions.item collection
...
func NewItemItemPullsCommentsItemReactionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemPullsCommentsItemReactionsRequestBuilder) {
    m := &ItemItemPullsCommentsItemReactionsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/repos/{repos%2Did}/{Owner%2Did}/pulls/comments/{comment_id}/reactions{?content*,per_page*,page*}", pathParameters),
    }
    return m
}
...
func (m *ItemItemPullsCommentsItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemPullsCommentsItemReactionsRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Reactionable, error) {
