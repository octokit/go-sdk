...
import (
    ...
    i1d06b738c213f1b6fa0d6f61f539205637a7f7ba758d90c75bf61005c7b54caa "github.com/octokit/go-sdk/github/octokit/repos/item/item/collaborators"
)
...
type ItemItemCollaboratorsRequestBuilderGetQueryParameters struct {
    ...
    // Filter collaborators returned by their affiliation. `outside` means all outside collaborators of an organization-owned repository. `direct` means all collaborators with permissions to an organization-owned repository, regardless of organization membership status. `all` means all collaborators the authenticated user can see.
    AffiliationAsGetAffiliationQueryParameterType *i1d06b738c213f1b6fa0d6f61f539205637a7f7ba758d90c75bf61005c7b54caa.GetAffiliationQueryParameterType `uriparametername:"affiliation"`
    ...
    // Filter collaborators by the permissions they have on the repository. If not specified, all collaborators will be returned.
    PermissionAsGetPermissionQueryParameterType *i1d06b738c213f1b6fa0d6f61f539205637a7f7ba758d90c75bf61005c7b54caa.GetPermissionQueryParameterType `uriparametername:"permission"`
}
...
// ByUsername gets an item from the octokit.repos.item.item.collaborators.item collection
...
func (m *ItemItemCollaboratorsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemCollaboratorsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Collaboratorable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateCollaboratorFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Collaboratorable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Collaboratorable)
        }
    }
    return val, nil
}
