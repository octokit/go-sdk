...
// ByRuleset_id gets an item from the octokit.repos.item.item.rulesets.item collection
...
// ByRuleset_idInteger gets an item from the octokit.repos.item.item.rulesets.item collection
...
func (m *ItemItemRulesetsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemRulesetsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.RepositoryRulesetable, error) {
...
func (m *ItemItemRulesetsRequestBuilder) Post(ctx context.Context, body ItemItemRulesetsPostRequestBodyable, requestConfiguration *ItemItemRulesetsRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.RepositoryRulesetable, error) {
