...
import (
    ...
    id6b3e4b9559e443fb82be5e6d1c923d436242d53a5b86a5c8ef5b71bb87f8dbe "github.com/octokit/go-sdk/github/octokit/repos/item/item/codescanning/analyses"
)
...
type ItemItemCodeScanningAnalysesRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *id6b3e4b9559e443fb82be5e6d1c923d436242d53a5b86a5c8ef5b71bb87f8dbe.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property by which to sort the results.
    SortAsGetSortQueryParameterType *id6b3e4b9559e443fb82be5e6d1c923d436242d53a5b86a5c8ef5b71bb87f8dbe.GetSortQueryParameterType `uriparametername:"sort"`
...
// ByAnalysis_id gets an item from the octokit.repos.item.item.codeScanning.analyses.item collection
...
// ByAnalysis_idInteger gets an item from the octokit.repos.item.item.codeScanning.analyses.item collection
...
func (m *ItemItemCodeScanningAnalysesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemCodeScanningAnalysesRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CodeScanningAnalysisable, error) {
    ...
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        ...
        "503": i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateAnalyses503ErrorFromDiscriminatorValue,
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateCodeScanningAnalysisFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CodeScanningAnalysisable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CodeScanningAnalysisable)
        }
    }
    return val, nil
}
