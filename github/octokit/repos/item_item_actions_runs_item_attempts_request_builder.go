...
// ItemItemActionsRunsItemAttemptsRequestBuilder builds and executes requests for operations under \repos\{repos-id}\{Owner-id}\actions\runs\{run_id}\attempts
type ItemItemActionsRunsItemAttemptsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ByAttempt_number gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.actions.runs.item.attempts.item collection
...
// ByAttempt_numberInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.repos.item.item.actions.runs.item.attempts.item collection
