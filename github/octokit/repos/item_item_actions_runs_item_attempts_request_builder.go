...
// ByAttempt_number gets an item from the octokit.repos.item.item.actions.runs.item.attempts.item collection
...
// ByAttempt_numberInteger gets an item from the octokit.repos.item.item.actions.runs.item.attempts.item collection
