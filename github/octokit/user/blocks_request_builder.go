...
// ByUsername gets an item from the octokit.user.blocks.item collection
...
func (m *BlocksRequestBuilder) Get(ctx context.Context, requestConfiguration *BlocksRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.SimpleUserable, error) {
