...
// BySsh_signing_key_id gets an item from the github.com/octokit/go-sdk/github/octokit/.user.ssh_signing_keys.item collection
...
// BySsh_signing_key_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.user.ssh_signing_keys.item collection
...
func (m *Ssh_signing_keysRequestBuilder) Get(ctx context.Context, requestConfiguration *Ssh_signing_keysRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.SshSigningKeyable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateSshSigningKeyFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.SshSigningKeyable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.SshSigningKeyable)
        }
    }
    return val, nil
}
...
func (m *Ssh_signing_keysRequestBuilder) Post(ctx context.Context, body Ssh_signing_keysPostRequestBodyable, requestConfiguration *Ssh_signing_keysRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.SshSigningKeyable, error) {
