...
// BySsh_signing_key_id gets an item from the octokit.user.ssh_signing_keys.item collection
...
// BySsh_signing_key_idInteger gets an item from the octokit.user.ssh_signing_keys.item collection
...
func (m *Ssh_signing_keysRequestBuilder) Get(ctx context.Context, requestConfiguration *Ssh_signing_keysRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.SshSigningKeyable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateSshSigningKeyFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *Ssh_signing_keysRequestBuilder) Post(ctx context.Context, body Ssh_signing_keysPostRequestBodyable, requestConfiguration *Ssh_signing_keysRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.SshSigningKeyable, error) {
