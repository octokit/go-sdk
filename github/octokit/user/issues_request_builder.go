...
import (
    ...
    iad7bdf1167f1cb8690098e897008518e55714653be128b6e95351eb5ad614e2e "github.com/octokit/go-sdk/github/octokit/user/issues"
)
...
type IssuesRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *iad7bdf1167f1cb8690098e897008518e55714653be128b6e95351eb5ad614e2e.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // Indicates which sorts of issues to return. `assigned` means issues assigned to you. `created` means issues created by you. `mentioned` means issues mentioning you. `subscribed` means issues you're subscribed to updates for. `all` or `repos` means all issues you can see, regardless of participation or creation.
    FilterAsGetFilterQueryParameterType *iad7bdf1167f1cb8690098e897008518e55714653be128b6e95351eb5ad614e2e.GetFilterQueryParameterType `uriparametername:"filter"`
    ...
    // What to sort results by.
    SortAsGetSortQueryParameterType *iad7bdf1167f1cb8690098e897008518e55714653be128b6e95351eb5ad614e2e.GetSortQueryParameterType `uriparametername:"sort"`
    // Indicates the state of the issues to return.
    // Deprecated: This property is deprecated, use stateAsGetStateQueryParameterType instead
    State *string `uriparametername:"state"`
    // Indicates the state of the issues to return.
    StateAsGetStateQueryParameterType *iad7bdf1167f1cb8690098e897008518e55714653be128b6e95351eb5ad614e2e.GetStateQueryParameterType `uriparametername:"state"`
}
...
func (m *IssuesRequestBuilder) Get(ctx context.Context, requestConfiguration *IssuesRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Issueable, error) {
