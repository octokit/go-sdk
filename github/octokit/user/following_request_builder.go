...
// ByUsername gets an item from the octokit.user.following.item collection
...
func (m *FollowingRequestBuilder) Get(ctx context.Context, requestConfiguration *FollowingRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.SimpleUserable, error) {
