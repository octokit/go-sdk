...
import (
    ...
    i37378a9c184540449e87b43a124c734e771006212f917d8d4044982cf95ee597 "github.com/octokit/go-sdk/github/octokit/user/starred"
)
...
type StarredRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *i37378a9c184540449e87b43a124c734e771006212f917d8d4044982cf95ee597.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by. `created` means when the repository was starred. `updated` means when the repository was last pushed to.
    SortAsGetSortQueryParameterType *i37378a9c184540449e87b43a124c734e771006212f917d8d4044982cf95ee597.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByOwner gets an item from the github.com/octokit/go-sdk/github/octokit/.user.starred.item collection
...
func (m *StarredRequestBuilder) Get(ctx context.Context, requestConfiguration *StarredRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Repositoryable, error) {
