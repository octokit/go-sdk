...
func (m *OrgsRequestBuilder) Get(ctx context.Context, requestConfiguration *OrgsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.OrganizationSimpleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateOrganizationSimpleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
