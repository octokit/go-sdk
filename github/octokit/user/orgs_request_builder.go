...
func (m *OrgsRequestBuilder) Get(ctx context.Context, requestConfiguration *OrgsRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrganizationSimpleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateOrganizationSimpleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
