...
// ByTeam_id gets an item from the github.com/octokit/go-sdk/github/octokit/.teams.item collection
...
// ByTeam_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.teams.item collection
// Deprecated: 
