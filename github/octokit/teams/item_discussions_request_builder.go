...
import (
    ...
    if537f8919ef5b0ce7c9c987f5521aa39d3cd404ada59f83b50d0d9ea22b84cfc "github.com/octokit/go-sdk/github/octokit/teams/item/discussions"
)
...
type ItemDiscussionsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *if537f8919ef5b0ce7c9c987f5521aa39d3cd404ada59f83b50d0d9ea22b84cfc.GetDirectionQueryParameterType `uriparametername:"direction"`
...
// ByDiscussion_number gets an item from the octokit.teams.item.discussions.item collection
...
// ByDiscussion_numberInteger gets an item from the octokit.teams.item.discussions.item collection
// Deprecated: 
...
func (m *ItemDiscussionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDiscussionsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.TeamDiscussionable, error) {
...
func (m *ItemDiscussionsRequestBuilder) Post(ctx context.Context, body ItemDiscussionsPostRequestBodyable, requestConfiguration *ItemDiscussionsRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.TeamDiscussionable, error) {
