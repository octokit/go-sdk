...
import (
    ...
    i1e76fb3ff2fc95bae391c97fbbed4e64cb8ef6fff8d522d18762db87bf0409d5 "github.com/octokit/go-sdk/github/octokit/teams/item/discussions/item/reactions"
)
...
type ItemDiscussionsItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion.
    ContentAsGetContentQueryParameterType *i1e76fb3ff2fc95bae391c97fbbed4e64cb8ef6fff8d522d18762db87bf0409d5.GetContentQueryParameterType `uriparametername:"content"`
...
func (m *ItemDiscussionsItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDiscussionsItemReactionsRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Reactionable, error) {
...
func (m *ItemDiscussionsItemReactionsRequestBuilder) Post(ctx context.Context, body ItemDiscussionsItemReactionsPostRequestBodyable, requestConfiguration *ItemDiscussionsItemReactionsRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Reactionable, error) {
