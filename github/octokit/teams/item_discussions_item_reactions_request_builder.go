...
import (
    ...
    ia6d07ce823c3035d40fa7e601b58258b317a510ae484789e6f1b56748151adfd "github.com/octokit/go-sdk/github/octokit/teams/item/discussions/item/reactions"
)
...
type ItemDiscussionsItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion.
    ContentAsGetContentQueryParameterType *ia6d07ce823c3035d40fa7e601b58258b317a510ae484789e6f1b56748151adfd.GetContentQueryParameterType `uriparametername:"content"`
...
func (m *ItemDiscussionsItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDiscussionsItemReactionsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Reactionable, error) {
...
func (m *ItemDiscussionsItemReactionsRequestBuilder) Post(ctx context.Context, body ItemDiscussionsItemReactionsPostRequestBodyable, requestConfiguration *ItemDiscussionsItemReactionsRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Reactionable, error) {
