...
import (
    ...
    i82816a272627b247fe980087d095661353104b749f1906b9a11f16dd6bd03a43 "github.com/octokit/go-sdk/github/octokit/users/item/hovercard"
)
...
type ItemHovercardRequestBuilderGetQueryParameters struct {
    ...
    // Identifies which additional information you'd like to receive about the person's hovercard. Can be `organization`, `repository`, `issue`, `pull_request`. **Required** when using `subject_id`.
    Subject_typeAsGetSubject_typeQueryParameterType *i82816a272627b247fe980087d095661353104b749f1906b9a11f16dd6bd03a43.GetSubject_typeQueryParameterType `uriparametername:"subject_type"`
}
...
func (m *ItemHovercardRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemHovercardRequestBuilderGetRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Hovercardable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateHovercardFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Hovercardable), nil
}
