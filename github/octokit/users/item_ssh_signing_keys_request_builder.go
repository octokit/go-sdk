...
func (m *ItemSsh_signing_keysRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSsh_signing_keysRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.SshSigningKeyable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateSshSigningKeyFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
