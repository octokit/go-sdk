...
import (
    ...
    ia44dc525509ea49eb0bb6a8ff317b015bd24ec18fd43c83bd545d88c9b8d9da2 "github.com/octokit/go-sdk/github/octokit/orgs/item/repos"
)
...
type ItemReposRequestBuilderGetQueryParameters struct {
    ...
    // The order to sort by. Default: `asc` when using `full_name`, otherwise `desc`.
    DirectionAsGetDirectionQueryParameterType *ia44dc525509ea49eb0bb6a8ff317b015bd24ec18fd43c83bd545d88c9b8d9da2.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by.
    SortAsGetSortQueryParameterType *ia44dc525509ea49eb0bb6a8ff317b015bd24ec18fd43c83bd545d88c9b8d9da2.GetSortQueryParameterType `uriparametername:"sort"`
    ...
    // Specifies the types of repositories you want returned.
    TypeAsGetTypeQueryParameterType *ia44dc525509ea49eb0bb6a8ff317b015bd24ec18fd43c83bd545d88c9b8d9da2.GetTypeQueryParameterType `uriparametername:"type"`
}
...
func (m *ItemReposRequestBuilder) Post(ctx context.Context, body ItemReposPostRequestBodyable, requestConfiguration *ItemReposRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.FullRepositoryable, error) {
