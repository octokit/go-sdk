...
import (
    ...
    i383a5ca4a2bd4601a6407e92a4ba81428a40f605edf3cd93a311bfcddf85ca7c "github.com/octokit/go-sdk/github/octokit/orgs/item/teams/item/discussions/item/comments/item/reactions"
)
...
type ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion comment.
    ContentAsGetContentQueryParameterType *i383a5ca4a2bd4601a6407e92a4ba81428a40f605edf3cd93a311bfcddf85ca7c.GetContentQueryParameterType `uriparametername:"content"`
...
// ByReaction_id gets an item from the octokit.orgs.item.teams.item.discussions.item.comments.item.reactions.item collection
...
// ByReaction_idInteger gets an item from the octokit.orgs.item.teams.item.discussions.item.comments.item.reactions.item collection
...
func (m *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Reactionable, error) {
...
func (m *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilder) Post(ctx context.Context, body ItemTeamsItemDiscussionsItemCommentsItemReactionsPostRequestBodyable, requestConfiguration *ItemTeamsItemDiscussionsItemCommentsItemReactionsRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Reactionable, error) {
