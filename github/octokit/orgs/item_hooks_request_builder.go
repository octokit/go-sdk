...
// ByHook_id gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.hooks.item collection
...
// ByHook_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.hooks.item collection
...
func (m *ItemHooksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemHooksRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrgHookable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateOrgHookFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrgHookable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrgHookable)
        }
    }
    return val, nil
}
...
func (m *ItemHooksRequestBuilder) Post(ctx context.Context, body ItemHooksPostRequestBodyable, requestConfiguration *ItemHooksRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrgHookable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateOrgHookFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrgHookable), nil
}
