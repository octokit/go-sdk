...
import (
    ...
    i5934a2bc6f7be97d5623fa6d45c551911cec8bf7a6c45422a55be157c01de7e2 "github.com/octokit/go-sdk/github/octokit/orgs/item/personalaccesstokens"
)
...
type ItemPersonalAccessTokensRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *i5934a2bc6f7be97d5623fa6d45c551911cec8bf7a6c45422a55be157c01de7e2.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property by which to sort the results.
    SortAsGetSortQueryParameterType *i5934a2bc6f7be97d5623fa6d45c551911cec8bf7a6c45422a55be157c01de7e2.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByPat_id gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.personalAccessTokens.item collection
...
// ByPat_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.personalAccessTokens.item collection
...
func (m *ItemPersonalAccessTokensRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPersonalAccessTokensRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrganizationProgrammaticAccessGrantable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateOrganizationProgrammaticAccessGrantFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrganizationProgrammaticAccessGrantable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrganizationProgrammaticAccessGrantable)
        }
    }
    return val, nil
}
