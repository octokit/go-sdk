...
import (
    ...
    id25989093a3e8debfb720a4963c469e0b1c48ae0523ebf19dc41139062e2a39b "github.com/octokit/go-sdk/github/octokit/orgs/item/personalaccesstokens"
)
...
type ItemPersonalAccessTokensRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *id25989093a3e8debfb720a4963c469e0b1c48ae0523ebf19dc41139062e2a39b.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property by which to sort the results.
    SortAsGetSortQueryParameterType *id25989093a3e8debfb720a4963c469e0b1c48ae0523ebf19dc41139062e2a39b.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByPat_id gets an item from the octokit.orgs.item.personalAccessTokens.item collection
...
// ByPat_idInteger gets an item from the octokit.orgs.item.personalAccessTokens.item collection
...
func (m *ItemPersonalAccessTokensRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemPersonalAccessTokensRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.OrganizationProgrammaticAccessGrantable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateOrganizationProgrammaticAccessGrantFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.OrganizationProgrammaticAccessGrantable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.OrganizationProgrammaticAccessGrantable)
        }
    }
    return val, nil
}
