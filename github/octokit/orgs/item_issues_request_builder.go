...
import (
    ...
    i2737087a865e0797383d730eb20e3c26941a6c65f0162f53a6a8960fd5de5d7b "github.com/octokit/go-sdk/github/octokit/orgs/item/issues"
)
...
type ItemIssuesRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *i2737087a865e0797383d730eb20e3c26941a6c65f0162f53a6a8960fd5de5d7b.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // Indicates which sorts of issues to return. `assigned` means issues assigned to you. `created` means issues created by you. `mentioned` means issues mentioning you. `subscribed` means issues you're subscribed to updates for. `all` or `repos` means all issues you can see, regardless of participation or creation.
    FilterAsGetFilterQueryParameterType *i2737087a865e0797383d730eb20e3c26941a6c65f0162f53a6a8960fd5de5d7b.GetFilterQueryParameterType `uriparametername:"filter"`
    ...
    // What to sort results by.
    SortAsGetSortQueryParameterType *i2737087a865e0797383d730eb20e3c26941a6c65f0162f53a6a8960fd5de5d7b.GetSortQueryParameterType `uriparametername:"sort"`
    // Indicates the state of the issues to return.
    // Deprecated: This property is deprecated, use stateAsGetStateQueryParameterType instead
    State *string `uriparametername:"state"`
    // Indicates the state of the issues to return.
    StateAsGetStateQueryParameterType *i2737087a865e0797383d730eb20e3c26941a6c65f0162f53a6a8960fd5de5d7b.GetStateQueryParameterType `uriparametername:"state"`
}
...
func (m *ItemIssuesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemIssuesRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Issueable, error) {
