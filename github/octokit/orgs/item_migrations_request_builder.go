...
// ByMigration_id gets an item from the octokit.orgs.item.migrations.item collection
...
// ByMigration_idInteger gets an item from the octokit.orgs.item.migrations.item collection
...
func (m *ItemMigrationsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMigrationsRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Migrationable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.CreateMigrationFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
...
func (m *ItemMigrationsRequestBuilder) Post(ctx context.Context, body ItemMigrationsPostRequestBodyable, requestConfiguration *ItemMigrationsRequestBuilderPostRequestConfiguration)(i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.Migrationable, error) {
