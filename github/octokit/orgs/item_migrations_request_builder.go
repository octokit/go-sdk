...
// ByMigration_id gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.migrations.item collection
...
// ByMigration_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.migrations.item collection
...
func (m *ItemMigrationsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemMigrationsRequestBuilderGetRequestConfiguration)([]i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Migrationable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateMigrationFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
...
func (m *ItemMigrationsRequestBuilder) Post(ctx context.Context, body ItemMigrationsPostRequestBodyable, requestConfiguration *ItemMigrationsRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.Migrationable, error) {
