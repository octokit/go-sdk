...
// ByDelivery_id gets an item from the octokit.orgs.item.hooks.item.deliveries.item collection
...
// ByDelivery_idInteger gets an item from the octokit.orgs.item.hooks.item.deliveries.item collection
...
func (m *ItemHooksItemDeliveriesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemHooksItemDeliveriesRequestBuilderGetRequestConfiguration)([]i8bb20811a612dd15efa26f086111481a68f72cd9ac5da7a939a417131078d77e.HookDeliveryItemable, error) {
