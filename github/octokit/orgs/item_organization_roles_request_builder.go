...
// ByRole_id gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.organizationRoles.item collection
...
// ByRole_idInteger gets an item from the github.com/octokit/go-sdk/github/octokit/.orgs.item.organizationRoles.item collection
...
func (m *ItemOrganizationRolesRequestBuilder) Post(ctx context.Context, body ItemOrganizationRolesPostRequestBodyable, requestConfiguration *ItemOrganizationRolesRequestBuilderPostRequestConfiguration)(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrganizationRoleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.CreateOrganizationRoleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i000736ae6dd74f01081193e4f903216bc2bd2954ed818433b986f45d581ed035.OrganizationRoleable), nil
}
