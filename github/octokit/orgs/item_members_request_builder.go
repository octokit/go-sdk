...
import (
    ...
    ie22191d50f55f816cbf6e1a53d75535843d9f17eb27c6762fe936d39d4da298a "github.com/octokit/go-sdk/github/octokit/orgs/item/members"
)
...
type ItemMembersRequestBuilderGetQueryParameters struct {
    ...
    // Filter members returned in the list. `2fa_disabled` means that only members without [two-factor authentication](https://github.com/blog/1614-two-factor-authentication) enabled will be returned. This options is only available for organization owners.
    FilterAsGetFilterQueryParameterType *ie22191d50f55f816cbf6e1a53d75535843d9f17eb27c6762fe936d39d4da298a.GetFilterQueryParameterType `uriparametername:"filter"`
    ...
    // Filter members returned by their role.
    RoleAsGetRoleQueryParameterType *ie22191d50f55f816cbf6e1a53d75535843d9f17eb27c6762fe936d39d4da298a.GetRoleQueryParameterType `uriparametername:"role"`
}
...
// ByUsername gets an item from the octokit.orgs.item.members.item collection
