...
// ByRepository_id gets an item from the octokit.orgs.item.codespaces.secrets.item.repositories.item collection
...
// ByRepository_idInteger gets an item from the octokit.orgs.item.codespaces.secrets.item.repositories.item collection
