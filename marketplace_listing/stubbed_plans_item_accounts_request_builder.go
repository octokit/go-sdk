...
import (
    ...
    idb82e7c3a428379b7c0f986e3fa053e54c5c00eecd2db5db256dfd3205fd1976 "github.com/octokit/go-sdk/marketplace_listing/stubbed/plans/item/accounts"
)
...
type StubbedPlansItemAccountsRequestBuilderGetQueryParameters struct {
    ...
    // To return the oldest accounts first, set to `asc`. Ignored without the `sort` parameter.
    DirectionAsGetDirectionQueryParameterType *idb82e7c3a428379b7c0f986e3fa053e54c5c00eecd2db5db256dfd3205fd1976.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by.
    SortAsGetSortQueryParameterType *idb82e7c3a428379b7c0f986e3fa053e54c5c00eecd2db5db256dfd3205fd1976.GetSortQueryParameterType `uriparametername:"sort"`
}
...
func (m *StubbedPlansItemAccountsRequestBuilder) Get(ctx context.Context, requestConfiguration *StubbedPlansItemAccountsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.MarketplacePurchaseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateMarketplacePurchaseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.MarketplacePurchaseable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.MarketplacePurchaseable)
        }
    }
    return val, nil
}
