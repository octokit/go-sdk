...
import (
    ...
    ife1442d4451a0c0dfcc08d2c083a519ad5776b4ea216d7dbebda621cc485c147 "github.com/octokit/go-sdk/marketplace_listing/plans/item/accounts"
)
...
type PlansItemAccountsRequestBuilderGetQueryParameters struct {
    ...
    // To return the oldest accounts first, set to `asc`. Ignored without the `sort` parameter.
    DirectionAsGetDirectionQueryParameterType *ife1442d4451a0c0dfcc08d2c083a519ad5776b4ea216d7dbebda621cc485c147.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by.
    SortAsGetSortQueryParameterType *ife1442d4451a0c0dfcc08d2c083a519ad5776b4ea216d7dbebda621cc485c147.GetSortQueryParameterType `uriparametername:"sort"`
}
...
func (m *PlansItemAccountsRequestBuilder) Get(ctx context.Context, requestConfiguration *PlansItemAccountsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.MarketplacePurchaseable, error) {
