...
import (
    ...
    if3b790bc348ab38e52405eb7285b78773dbb220f74adfbc1c96b8c40bd092433 "github.com/octokit/go-sdk/projects/columns/item/cards"
)
...
type ColumnsItemCardsRequestBuilderGetQueryParameters struct {
    ...
    // Filters the project cards that are returned by the card's state.
    Archived_stateAsGetArchived_stateQueryParameterType *if3b790bc348ab38e52405eb7285b78773dbb220f74adfbc1c96b8c40bd092433.GetArchived_stateQueryParameterType `uriparametername:"archived_state"`
...
type ProjectCard422Error struct {
    ...
    validationError i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorable
    // Composed type representation for type validationErrorSimple
    validationErrorSimple i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorSimpleable
}
...
func (m *ProjectCard422Error) GetValidationError()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorable) {
...
func (m *ProjectCard422Error) GetValidationErrorSimple()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorSimpleable) {
...
func (m *ProjectCard422Error) SetValidationError(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorable)() {
...
func (m *ProjectCard422Error) SetValidationErrorSimple(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorSimpleable)() {
...
type ProjectCard422Errorable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetValidationError()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorable)
    GetValidationErrorSimple()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorSimpleable)
    SetValidationError(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorable)()
    SetValidationErrorSimple(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ValidationErrorSimpleable)()
}
...
func (m *ColumnsItemCardsRequestBuilder) Get(ctx context.Context, requestConfiguration *ColumnsItemCardsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ProjectCardable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateProjectCardFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ProjectCardable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ProjectCardable)
        }
    }
    return val, nil
}
...
func (m *ColumnsItemCardsRequestBuilder) Post(ctx context.Context, body CardsPostRequestBodyable, requestConfiguration *ColumnsItemCardsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ProjectCardable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateProjectCardFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.ProjectCardable), nil
}
