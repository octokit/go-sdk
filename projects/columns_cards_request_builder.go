...
// ByCard_id gets an item from the go-sdk.projects.columns.cards.item collection
...
// ByCard_idInteger gets an item from the go-sdk.projects.columns.cards.item collection
