...
// ByProject_id gets an item from the go-sdk.teams.item.projects.item collection
...
// ByProject_idInteger gets an item from the go-sdk.teams.item.projects.item collection
// Deprecated: 
...
func (m *ItemProjectsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemProjectsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.TeamProjectable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateTeamProjectFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
