...
import (
    ...
    icd987df7a99ce8056bd40b57c699942411a2339b2cc19bdb0de5c6f24bf2c23f "github.com/octokit/go-sdk/teams/item/discussions"
)
...
type ItemDiscussionsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *icd987df7a99ce8056bd40b57c699942411a2339b2cc19bdb0de5c6f24bf2c23f.GetDirectionQueryParameterType `uriparametername:"direction"`
...
// ByDiscussion_number gets an item from the go-sdk.teams.item.discussions.item collection
...
// ByDiscussion_numberInteger gets an item from the go-sdk.teams.item.discussions.item collection
// Deprecated: 
...
func (m *ItemDiscussionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemDiscussionsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.TeamDiscussionable, error) {
...
func (m *ItemDiscussionsRequestBuilder) Post(ctx context.Context, body ItemDiscussionsPostRequestBodyable, requestConfiguration *ItemDiscussionsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.TeamDiscussionable, error) {
