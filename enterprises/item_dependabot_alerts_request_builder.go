...
import (
    ...
    if1fcc6bc1c21266517cc7342a622c165edc663d2f200e62783a51d8579d4bfb0 "github.com/octokit/go-sdk/enterprises/item/dependabot/alerts"
)
...
type ItemDependabotAlertsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *if1fcc6bc1c21266517cc7342a622c165edc663d2f200e62783a51d8579d4bfb0.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The scope of the vulnerable dependency. If specified, only alerts with this scope will be returned.
    ScopeAsGetScopeQueryParameterType *if1fcc6bc1c21266517cc7342a622c165edc663d2f200e62783a51d8579d4bfb0.GetScopeQueryParameterType `uriparametername:"scope"`
    ...
    // The property by which to sort the results.`created` means when the alert was created.`updated` means when the alert's state last changed.
    SortAsGetSortQueryParameterType *if1fcc6bc1c21266517cc7342a622c165edc663d2f200e62783a51d8579d4bfb0.GetSortQueryParameterType `uriparametername:"sort"`
