...
import (
    ...
    ib558dea9a1a4478cc8551987919ce36f322d9b9897938918e825a11b8d975f8d "github.com/octokit/go-sdk/enterprises/item/secretscanning/alerts"
)
...
type ItemSecretScanningAlertsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *ib558dea9a1a4478cc8551987919ce36f322d9b9897938918e825a11b8d975f8d.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by. `created` means when the alert was created. `updated` means when the alert was updated or resolved.
    SortAsGetSortQueryParameterType *ib558dea9a1a4478cc8551987919ce36f322d9b9897938918e825a11b8d975f8d.GetSortQueryParameterType `uriparametername:"sort"`
    // Set to `open` or `resolved` to only list secret scanning alerts in a specific state.
    // Deprecated: This property is deprecated, use stateAsGetStateQueryParameterType instead
    State *string `uriparametername:"state"`
    // Set to `open` or `resolved` to only list secret scanning alerts in a specific state.
    StateAsGetStateQueryParameterType *ib558dea9a1a4478cc8551987919ce36f322d9b9897938918e825a11b8d975f8d.GetStateQueryParameterType `uriparametername:"state"`
...
func (m *ItemSecretScanningAlertsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemSecretScanningAlertsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationSecretScanningAlertable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateOrganizationSecretScanningAlertFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationSecretScanningAlertable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.OrganizationSecretScanningAlertable)
        }
    }
    return val, nil
}
