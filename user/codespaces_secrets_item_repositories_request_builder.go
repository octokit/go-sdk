...
// ByRepository_id gets an item from the go-sdk.user.codespaces.secrets.item.repositories.item collection
...
// ByRepository_idInteger gets an item from the go-sdk.user.codespaces.secrets.item.repositories.item collection
