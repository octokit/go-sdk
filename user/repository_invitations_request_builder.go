...
// ByInvitation_id gets an item from the go-sdk.user.repository_invitations.item collection
...
// ByInvitation_idInteger gets an item from the go-sdk.user.repository_invitations.item collection
...
func (m *Repository_invitationsRequestBuilder) Get(ctx context.Context, requestConfiguration *Repository_invitationsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RepositoryInvitationable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateRepositoryInvitationFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
