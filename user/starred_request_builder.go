...
import (
    ...
    id1c67d65f99d8974b4c1b022fc9e1439d7e76eb820d5edf6172ae79d9c5e3170 "github.com/octokit/go-sdk/user/starred"
)
...
type StarredRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *id1c67d65f99d8974b4c1b022fc9e1439d7e76eb820d5edf6172ae79d9c5e3170.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by. `created` means when the repository was starred. `updated` means when the repository was last pushed to.
    SortAsGetSortQueryParameterType *id1c67d65f99d8974b4c1b022fc9e1439d7e76eb820d5edf6172ae79d9c5e3170.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByOwner gets an item from the go-sdk.user.starred.item collection
...
func (m *StarredRequestBuilder) Get(ctx context.Context, requestConfiguration *StarredRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Repositoryable, error) {
