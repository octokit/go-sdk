...
type InteractionLimitsGetResponse struct {
    ...
    interactionLimitResponse i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable
...
func CreateInteractionLimitsGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    ...
    if parseNode != nil {
        if val, err := parseNode.GetObjectValue(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateInteractionLimitResponseFromDiscriminatorValue); val != nil {
            if err != nil {
                return nil, err
            }
            if cast, ok := val.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable); ok {
...
func (m *InteractionLimitsGetResponse) GetInteractionLimitResponse()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable) {
...
func (m *InteractionLimitsGetResponse) SetInteractionLimitResponse(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable)() {
...
// GetInteractionLimitResponse gets the interactionLimitResponse property value. Composed type representation for type interactionLimitResponse
func (m *InteractionLimitsResponse) GetInteractionLimitResponse()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable) {
    return m.interactionLimitResponse
}
// GetInteractionLimitsGetResponseMember1 gets the InteractionLimitsGetResponseMember1 property value. Composed type representation for type InteractionLimitsGetResponseMember1
...
// SetInteractionLimitResponse sets the interactionLimitResponse property value. Composed type representation for type interactionLimitResponse
func (m *InteractionLimitsResponse) SetInteractionLimitResponse(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable)() {
    m.interactionLimitResponse = value
}
// SetInteractionLimitsGetResponseMember1 sets the InteractionLimitsGetResponseMember1 property value. Composed type representation for type InteractionLimitsGetResponseMember1
...
type InteractionLimitsGetResponseable interface {
    ...
    GetInteractionLimitResponse()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable)
    GetInteractionLimitsGetResponseMember1()(InteractionLimitsGetResponseMember1able)
    SetInteractionLimitResponse(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable)()
...
func (m *InteractionLimitsRequestBuilder) Put(ctx context.Context, body i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitable, requestConfiguration *InteractionLimitsRequestBuilderPutRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateInteractionLimitResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitResponseable), nil
}
...
func (m *InteractionLimitsRequestBuilder) ToPutRequestInformation(ctx context.Context, body i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.InteractionLimitable, requestConfiguration *InteractionLimitsRequestBuilderPutRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
    requestInfo := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewRequestInformation()
    if requestConfiguration != nil {
        requestInfo.Headers.AddAll(requestConfiguration.Headers)
        requestInfo.AddRequestOptions(requestConfiguration.Options)
