...
type ItemItemActionsWorkflowsItemRunsGetResponse struct {
    ...
    workflow_runs []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable
}
...
func (m *ItemItemActionsWorkflowsItemRunsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["workflow_runs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateWorkflowRunFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable)
                }
            }
...
func (m *ItemItemActionsWorkflowsItemRunsGetResponse) GetWorkflowRuns()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable) {
...
func (m *ItemItemActionsWorkflowsItemRunsGetResponse) SetWorkflowRuns(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable)() {
...
type ItemItemActionsWorkflowsItemRunsGetResponseable interface {
    ...
    GetTotalCount()(*int32)
    GetWorkflowRuns()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable)
    SetTotalCount(value *int32)()
    SetWorkflowRuns(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WorkflowRunable)()
}
