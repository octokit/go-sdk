...
import (
    ...
    i5068be399cb12753fb0d8070365de192a24cb68b380ce5d2a72ad2f15b9105fc "github.com/octokit/go-sdk/repos/item/item/secretscanning/alerts"
)
...
type ItemItemSecretScanningAlertsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort the results by.
    DirectionAsGetDirectionQueryParameterType *i5068be399cb12753fb0d8070365de192a24cb68b380ce5d2a72ad2f15b9105fc.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by. `created` means when the alert was created. `updated` means when the alert was updated or resolved.
    SortAsGetSortQueryParameterType *i5068be399cb12753fb0d8070365de192a24cb68b380ce5d2a72ad2f15b9105fc.GetSortQueryParameterType `uriparametername:"sort"`
    // Set to `open` or `resolved` to only list secret scanning alerts in a specific state.
    // Deprecated: This property is deprecated, use stateAsGetStateQueryParameterType instead
    State *string `uriparametername:"state"`
    // Set to `open` or `resolved` to only list secret scanning alerts in a specific state.
    StateAsGetStateQueryParameterType *i5068be399cb12753fb0d8070365de192a24cb68b380ce5d2a72ad2f15b9105fc.GetStateQueryParameterType `uriparametername:"state"`
...
// ByAlert_number gets an item from the go-sdk.repos.item.item.secretScanning.alerts.item collection
...
// ByAlert_numberInteger gets an item from the go-sdk.repos.item.item.secretScanning.alerts.item collection
...
func (m *ItemItemSecretScanningAlertsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemSecretScanningAlertsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SecretScanningAlertable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateSecretScanningAlertFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SecretScanningAlertable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SecretScanningAlertable)
        }
    }
    return val, nil
}
