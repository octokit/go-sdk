...
type ItemItemCodespacesNewGetResponse struct {
    ...
    // A GitHub user.
    billable_owner i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SimpleUserable
...
func (m *ItemItemCodespacesNewGetResponse) GetBillableOwner()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SimpleUserable) {
...
func (m *ItemItemCodespacesNewGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["billable_owner"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateSimpleUserFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetBillableOwner(val.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SimpleUserable))
        }
        return nil
    }
...
func (m *ItemItemCodespacesNewGetResponse) SetBillableOwner(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SimpleUserable)() {
...
type ItemItemCodespacesNewGetResponseable interface {
    ...
    GetBillableOwner()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SimpleUserable)
    GetDefaults()(ItemItemCodespacesNewGetResponse_defaultsable)
    SetBillableOwner(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.SimpleUserable)()
