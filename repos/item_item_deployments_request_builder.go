...
// ByDeployment_id gets an item from the go-sdk.repos.item.item.deployments.item collection
...
// ByDeployment_idInteger gets an item from the go-sdk.repos.item.item.deployments.item collection
...
func (m *ItemItemDeploymentsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemDeploymentsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Deploymentable, error) {
...
func (m *ItemItemDeploymentsRequestBuilder) Post(ctx context.Context, body ItemItemDeploymentsPostRequestBodyable, requestConfiguration *ItemItemDeploymentsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Deploymentable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateDeploymentFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Deploymentable), nil
}
