...
// ByJob_id gets an item from the go-sdk.repos.item.item.actions.jobs.item collection
...
// ByJob_idInteger gets an item from the go-sdk.repos.item.item.actions.jobs.item collection
