...
// ByAsset_id gets an item from the go-sdk.repos.item.item.releases.assets.item collection
...
// ByAsset_idInteger gets an item from the go-sdk.repos.item.item.releases.assets.item collection
