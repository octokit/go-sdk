...
import (
    ...
    i73eb98989dc4c747cf502552ef67286ee15972e58fd47dc91e9b52646fded540 "github.com/octokit/go-sdk/repos/item/item/actions/runs"
)
...
type ItemItemActionsRunsRequestBuilderGetQueryParameters struct {
    ...
    // Returns workflow runs with the check run `status` or `conclusion` that you specify. For example, a conclusion can be `success` or a status can be `in_progress`. Only GitHub can set a status of `waiting` or `requested`.
    StatusAsGetStatusQueryParameterType *i73eb98989dc4c747cf502552ef67286ee15972e58fd47dc91e9b52646fded540.GetStatusQueryParameterType `uriparametername:"status"`
}
...
// ByRun_id gets an item from the go-sdk.repos.item.item.actions.runs.item collection
...
// ByRun_idInteger gets an item from the go-sdk.repos.item.item.actions.runs.item collection
