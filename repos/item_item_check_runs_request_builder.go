...
// ByCheck_run_id gets an item from the go-sdk.repos.item.item.checkRuns.item collection
...
// ByCheck_run_idInteger gets an item from the go-sdk.repos.item.item.checkRuns.item collection
...
func (m *ItemItemCheckRunsRequestBuilder) Post(ctx context.Context, body CheckRunsPostRequestBodyable, requestConfiguration *ItemItemCheckRunsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable, error) {
