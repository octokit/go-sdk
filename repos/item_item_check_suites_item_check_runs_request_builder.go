...
import (
    ...
    i74cb133d083b66d00a7605d1a7037c65c6303d3b18be502658cd5d4b4907c2b0 "github.com/octokit/go-sdk/repos/item/item/checksuites/item/checkruns"
)
...
type ItemItemCheckSuitesItemCheckRunsRequestBuilderGetQueryParameters struct {
    ...
    // Filters check runs by their `completed_at` timestamp. `latest` returns the most recent check runs.
    FilterAsGetFilterQueryParameterType *i74cb133d083b66d00a7605d1a7037c65c6303d3b18be502658cd5d4b4907c2b0.GetFilterQueryParameterType `uriparametername:"filter"`
    ...
    // Returns check runs with the specified `status`.
    StatusAsGetStatusQueryParameterType *i74cb133d083b66d00a7605d1a7037c65c6303d3b18be502658cd5d4b4907c2b0.GetStatusQueryParameterType `uriparametername:"status"`
}
