...
import (
    ...
    i90e598affa765f4823c079810f5b6568d3b6f9f312e0b8c0a9fd8330ddbdc0ec "github.com/octokit/go-sdk/repos/item/item/pulls/comments/item/reactions"
)
...
type ItemItemPullsCommentsItemReactionsRequestBuilderGetQueryParameters struct {
    ...
    // Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a pull request review comment.
    ContentAsGetContentQueryParameterType *i90e598affa765f4823c079810f5b6568d3b6f9f312e0b8c0a9fd8330ddbdc0ec.GetContentQueryParameterType `uriparametername:"content"`
...
// ByReaction_id gets an item from the go-sdk.repos.item.item.pulls.comments.item.reactions.item collection
...
// ByReaction_idInteger gets an item from the go-sdk.repos.item.item.pulls.comments.item.reactions.item collection
...
func (m *ItemItemPullsCommentsItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemPullsCommentsItemReactionsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Reactionable, error) {
