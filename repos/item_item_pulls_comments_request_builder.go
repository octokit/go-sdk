...
import (
    ...
    ia5c26c1740474a859ec08267fa60d8241399e3d48a507281ff2924809cbaf6e0 "github.com/octokit/go-sdk/repos/item/item/pulls/comments"
)
...
type ItemItemPullsCommentsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort results. Ignored without `sort` parameter.
    DirectionAsGetDirectionQueryParameterType *ia5c26c1740474a859ec08267fa60d8241399e3d48a507281ff2924809cbaf6e0.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // 
    SortAsGetSortQueryParameterType *ia5c26c1740474a859ec08267fa60d8241399e3d48a507281ff2924809cbaf6e0.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByComment_id gets an item from the go-sdk.repos.item.item.pulls.comments.item collection
...
// ByComment_idInteger gets an item from the go-sdk.repos.item.item.pulls.comments.item collection
...
func (m *ItemItemPullsCommentsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemPullsCommentsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.PullRequestReviewCommentable, error) {
