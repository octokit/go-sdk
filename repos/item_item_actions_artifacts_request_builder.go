...
// ByArtifact_id gets an item from the go-sdk.repos.item.item.actions.artifacts.item collection
...
// ByArtifact_idInteger gets an item from the go-sdk.repos.item.item.actions.artifacts.item collection
