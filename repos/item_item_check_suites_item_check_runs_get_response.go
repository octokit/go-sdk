...
type ItemItemCheckSuitesItemCheckRunsGetResponse struct {
    ...
    check_runs []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable
...
func (m *ItemItemCheckSuitesItemCheckRunsGetResponse) GetCheckRuns()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable) {
    return m.check_runs
}
...
func (m *ItemItemCheckSuitesItemCheckRunsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["check_runs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateCheckRunFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable)
                }
            }
            m.SetCheckRuns(res)
        }
...
func (m *ItemItemCheckSuitesItemCheckRunsGetResponse) SetCheckRuns(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable)() {
    m.check_runs = value
}
...
type ItemItemCheckSuitesItemCheckRunsGetResponseable interface {
    ...
    GetCheckRuns()([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable)
    GetTotalCount()(*int32)
    SetCheckRuns(value []i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CheckRunable)()
