...
import (
    ...
    i9e1055eb8991b1994645373f3aabf66a8bb3a5b9f39f38bc57e65ece8bbe19fc "github.com/octokit/go-sdk/repos/item/item/pulls/item/comments"
)
...
type ItemItemPullsItemCommentsRequestBuilderGetQueryParameters struct {
    ...
    // The direction to sort results. Ignored without `sort` parameter.
    DirectionAsGetDirectionQueryParameterType *i9e1055eb8991b1994645373f3aabf66a8bb3a5b9f39f38bc57e65ece8bbe19fc.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // The property to sort the results by.
    SortAsGetSortQueryParameterType *i9e1055eb8991b1994645373f3aabf66a8bb3a5b9f39f38bc57e65ece8bbe19fc.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// ByComment_id gets an item from the go-sdk.repos.item.item.pulls.item.comments.item collection
...
func (m *ItemItemPullsItemCommentsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemPullsItemCommentsRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.PullRequestReviewCommentable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreatePullRequestReviewCommentFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.PullRequestReviewCommentable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.PullRequestReviewCommentable)
        }
    }
    return val, nil
}
...
func (m *ItemItemPullsItemCommentsRequestBuilder) Post(ctx context.Context, body ItemItemPullsItemCommentsPostRequestBodyable, requestConfiguration *ItemItemPullsItemCommentsRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.PullRequestReviewCommentable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreatePullRequestReviewCommentFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.PullRequestReviewCommentable), nil
}
