...
type ItemItemActionsRunnersGenerateJitconfigPostResponse struct {
    ...
    runner i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Runnerable
}
...
func (m *ItemItemActionsRunnersGenerateJitconfigPostResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["runner"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateRunnerFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRunner(val.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Runnerable))
        }
        return nil
    }
    return res
...
func (m *ItemItemActionsRunnersGenerateJitconfigPostResponse) GetRunner()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Runnerable) {
    return m.runner
}
...
func (m *ItemItemActionsRunnersGenerateJitconfigPostResponse) SetRunner(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Runnerable)() {
    m.runner = value
}
...
type ItemItemActionsRunnersGenerateJitconfigPostResponseable interface {
    ...
    GetRunner()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Runnerable)
    SetEncodedJitConfig(value *string)()
    SetRunner(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.Runnerable)()
}
