...
type ItemItemHooksItemWithHook_PatchRequestBody_config struct {
    ...
    insecure_ssl i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WebhookConfigInsecureSslable
    // The room property
    room *string
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody_config) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["insecure_ssl"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateWebhookConfigInsecureSslFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetInsecureSsl(val.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WebhookConfigInsecureSslable))
        }
        return nil
    }
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody_config) GetInsecureSsl()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WebhookConfigInsecureSslable) {
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody_config) SetInsecureSsl(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WebhookConfigInsecureSslable)() {
...
type ItemItemHooksItemWithHook_PatchRequestBody_configable interface {
    ...
    GetInsecureSsl()(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WebhookConfigInsecureSslable)
    GetRoom()(*string)
    GetSecret()(*string)
    GetUrl()(*string)
    SetAddress(value *string)()
    SetContentType(value *string)()
    SetInsecureSsl(value i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.WebhookConfigInsecureSslable)()
