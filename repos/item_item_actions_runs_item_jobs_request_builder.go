...
import (
    ...
    i669ba7725adf35860f4b144bc8bb3e26876a6d69d609fabeccef4e8f367bd9cd "github.com/octokit/go-sdk/repos/item/item/actions/runs/item/jobs"
)
...
type ItemItemActionsRunsItemJobsRequestBuilderGetQueryParameters struct {
    ...
    // Filters jobs by their `completed_at` timestamp. `latest` returns jobs from the most recent execution of the workflow run. `all` returns all jobs for a workflow run, including from old executions of the workflow run.
    FilterAsGetFilterQueryParameterType *i669ba7725adf35860f4b144bc8bb3e26876a6d69d609fabeccef4e8f367bd9cd.GetFilterQueryParameterType `uriparametername:"filter"`
