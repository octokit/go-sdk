...
// ByProtection_rule_id gets an item from the go-sdk.repos.item.item.environments.item.deployment_protection_rules.item collection
...
// ByProtection_rule_idInteger gets an item from the go-sdk.repos.item.item.environments.item.deployment_protection_rules.item collection
...
func (m *ItemItemEnvironmentsItemDeployment_protection_rulesRequestBuilder) Post(ctx context.Context, body ItemItemEnvironmentsItemDeployment_protection_rulesPostRequestBodyable, requestConfiguration *ItemItemEnvironmentsItemDeployment_protection_rulesRequestBuilderPostRequestConfiguration)(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.DeploymentProtectionRuleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateDeploymentProtectionRuleFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.DeploymentProtectionRuleable), nil
}
