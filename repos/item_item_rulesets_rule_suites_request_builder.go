...
import (
    ...
    i653bf156fc7e986da31e39d89e0b6ffff084b66ed239fec946539ee0e5ece053 "github.com/octokit/go-sdk/repos/item/item/rulesets/rulesuites"
)
...
type ItemItemRulesetsRuleSuitesRequestBuilderGetQueryParameters struct {
    ...
    // The rule results to filter on. When specified, only suites with this result will be returned.
    Rule_suite_resultAsGetRule_suite_resultQueryParameterType *i653bf156fc7e986da31e39d89e0b6ffff084b66ed239fec946539ee0e5ece053.GetRule_suite_resultQueryParameterType `uriparametername:"rule_suite_result"`
    ...
    // The time period to filter by.For example, `day` will filter for rule suites that occurred in the past 24 hours, and `week` will filter for insights that occurred in the past 7 days (168 hours).
    Time_periodAsGetTime_periodQueryParameterType *i653bf156fc7e986da31e39d89e0b6ffff084b66ed239fec946539ee0e5ece053.GetTime_periodQueryParameterType `uriparametername:"time_period"`
}
...
// ByRule_suite_id gets an item from the go-sdk.repos.item.item.rulesets.ruleSuites.item collection
...
// ByRule_suite_idInteger gets an item from the go-sdk.repos.item.item.rulesets.ruleSuites.item collection
...
func (m *ItemItemRulesetsRuleSuitesRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemRulesetsRuleSuitesRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RuleSuitesable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.CreateRuleSuitesFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RuleSuitesable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.RuleSuitesable)
        }
    }
    return val, nil
}
