...
// ByRepository_id gets an item from the go-sdk.repositories.item collection
...
func (m *RepositoriesRequestBuilder) Get(ctx context.Context, requestConfiguration *RepositoriesRequestBuilderGetRequestConfiguration)([]i33bcfa37677dfd8b71eaf22ad3bfd140ba1702e7a8418558499c22418bf2fef2.MinimalRepositoryable, error) {
